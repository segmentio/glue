...
func templatesClientGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/client.gohtml", size: 710, mode: os.FileMode(420), modTime: time.Unix(1510737333, 0)}
